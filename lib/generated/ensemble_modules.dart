...
class EnsembleModules {
  ...
  Future<void> init() async {
    ...
    if (useNotifications || useFirebaseAnalytics) {
      ...
      try {
        FirebaseOptions? androidPayload;
        FirebaseOptions? iosPayload;
        FirebaseOptions? webPayload;
        iosPayload = const FirebaseOptions(
          apiKey: "AIzaSyB3x7-ms9ZxnmP0jDcjHKH9AQA9j2odyXI",
          appId: "1:812708780714:ios:13ece45491fd50dd444ed3",
          messagingSenderId: "812708780714",
          projectId: "build-system-v2",
        );
